...
if (isset($_POST['id']) || (isset($_POST['title']) && isset($_POST['start'])) || isset($_POST['titulo']) || isset($_POST['fecha'])|| isset($_POST['Eid'])) {
    ...
    if (isset($_POST['id']) && isset($_POST['titulo']) && isset($_POST['fecha']) ) {
        $insCalendar = new CalendarControlador();
