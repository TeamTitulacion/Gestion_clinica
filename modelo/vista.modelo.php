...
class VistasModelo
{
    protected function MdlMostrarVistas($vistas)
    {
        ...
        ,"panelswells","tables","typography","404","salir","egg","pacientesearch","citas","medico","Rgmedico","formularios","Edmedico","perfil","hpaciente","reporteria","repmedicos","permiso","galeria"];
