...
class HistoriaModelo extends mainModel
{
    ...
    protected function MdlActualizar($datos,$datos2)
    {
        ...
        $sql6="UPDATE tbl_encabezadop AS e, tbl_cuerpop AS c,tbl_dientesp as d SET d.die_1= :d1,d.die_2= :d2,d.die_3= :d3,d.die_4= :d4,d.die_5= :d5,d.die_6= :d6,d.die_7= :d7,d.die_8= :d8,d.die_9= :d9,d.die_10= :d10,d.die_11= :d11,d.die_12= :d12,d.die_13= :d13,d.die_14= :d14,
        d.die_15= :d15,d.die_16= :d16,d.die_17= :d17,d.die_18= :d18,d.die_19= :d19,d.die_20= :d20,d.die_21= :d21,d.die_22= :d22,d.die_23= :d23,d.die_24= :d24,d.die_25= :d25,d.die_26= :d26,d.die_27= :d27,d.die_28= :d28,d.die_29= :d29,d.die_30= :d30,d.die_31= :d31,d.die_32= :d32,
        d.die_33= :d33,d.die_34= :d34,d.die_35= :d35,d.die_36= :d36,d.die_37= :d37,d.die_38= :d38,d.die_39= :d39,d.die_40= :d40,d.die_41= :d41,d.die_42= :d42,d.die_43= :d43,d.die_44= :d44,d.die_45= :d45,d.die_46= :d46,d.die_47= :d47,d.die_48= :d48,d.die_49= :d49,d.die_50= :d50,
        d.die_51= :d51,d.die_52= :d52 WHERE e.` id_encabezado`=c.id_encabezado AND e.enc_nhistoria=:id AND c.id_cuerpo=d.id_cuerpo";
        ...
        $sql8="UPDATE tbl_encabezadop AS e, tbl_cuerpop AS c,tbl_haccionprevp as ha SET ha.hac_hi_oral=:ha1,ha.ha_diario=:ha2,ha.ha_dental=:ha3 ,ha.ha_bucal=:ha4, ha.ha_fluor=:ha5 ,ha.ha_sellantes=:ha6,ha.ha_hi1=:ha7,ha.ha_hi2=:ha8, ha.ha_hi3=:ha9,ha.ha_hi4=:ha10,ha.ha_hi5=:ha11,
        ha.ha_hi6=:ha12 WHERE e.` id_encabezado`=c.id_encabezado AND e.enc_nhistoria=:id AND c.id_cuerpo=ha.id_cuerpo";

        $sqlmatriz=[$sql1,$sql2,$sql3,$sql4,$sql5,$sql6,$sql7,$sql8];
        ...
        $dmatriz=[$d1,$d2,$d3,$d4,$d5,$d6,$d7,$d8];
        $cont=0;
        for ($i=0; $i <=7 ; $i++) { 
