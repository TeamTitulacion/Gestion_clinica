...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCYXTGgrbnMaIo8ywuHhRXzE_BTjvXjvE0&callback=initMap&libraries=&v=weekly&channel=2"
      async
    ></script>
<!-- dash -->
...
<!--Full calendar-->
<!--<script src="<?php echo SERVERURL ?>/vista/js/fullcalendar/bootstrap.bundle.min.js"></script>-->
